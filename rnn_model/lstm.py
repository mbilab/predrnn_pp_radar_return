...
class cslstm(nn.Module):
    def __init__(self, layer_name, filter_size, num_hidden_in, num_hidden_out,
        ...
        self.h_norm = nn.LayerNorm([num_hidden_out*4, self.height, self.width])
        self.c_norm = nn.LayerNorm([num_hidden_out*3, self.height, self.width])
        self.m_norm = nn.LayerNorm([num_hidden_out*3, self.height, self.width])
        self.x_norm = nn.LayerNorm([num_hidden_out*7, self.height, self.width])
        self.c2m_norm = nn.LayerNorm([num_hidden_out*4, self.height, self.width])
        self.o_m_norm = nn.LayerNorm([num_hidden_out, self.height, self.width])
